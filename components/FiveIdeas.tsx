...
export function FiveIdeas() {
  ...
  return (
    <SectionWrapper
      ...
      lede="VCs trust their network, for intros, for diligence, for everything. First 30 days: find which channel actually creates pipeline, a dinner, an event, a free compliance session and then test it and then scale it."
      wide
    >
